...
* Создать аккаунт на GitHab.com;
* Создать локальный репозиторий;
* Подружить наш локальный и удаленный репозиторий. Копировать удаленнный репозиторий на свой ПК можно командой git clone [адрес удаленного репозитория].
* Отправить (push) ваш локальный репозиторий в удаленный на GitHab.
* Произвести изменения с другого компьюетра (в нашем случае сделать это в репозитории на GitHub).
